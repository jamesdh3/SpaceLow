...
public class Orbit : MonoBehaviour
{
    ...
    [SerializeField]
    private bool _orbitalZ, _lineTrajectory, _orbitalY; 
    ...
    void Start()
    {
        ...
        Vector3 _originalPosition = _originalObject.transform.position;
        Quaternion _originalRotation = _originalObject.transform.rotation;
    }
